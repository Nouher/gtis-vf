...
export default function Topbar() {
    return (
      <div className="bg-transparent  px-20 w-full  fixed top-0 z-50 items-center justify-between hidden lg:flex">
        <div className="border-b- flex flex-row-reverse items-center justify-between w-full h-12">
          ...
          <div className="flex gap-5 items-center h-full py-2">
            <Link href="#" className="flex gap-2 items-center hover:opacity-100 text-white opacity-70 transition cursor-pointer">
            ...
            <Link href='#' className="flex gap-2 items-center hover:opacity-100 text-white opacity-70 transition cursor-pointer hover:text-white">
              <MailIcon size={16} className="text-white opacity-70 "/>
              <span className="font-bold text-white opacity-70 text-xs">contact@gtis.ma</span>
            </Link>
          </div>
        </div>
